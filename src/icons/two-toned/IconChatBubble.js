...
class IconChatBubble extends React.Component<TwoTonedOutlinedIcon> {
    componentWillMount() {
    ...
    render() {
        const { className = '', height = 24, outlineColor, outlineWidth, title, width = 24 } = this.props;
        const filterProp = outlineColor && outlineWidth ? `url(#${this.outlineId})` : undefined;
